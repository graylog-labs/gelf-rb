    ...
    def send
      ...
      if data.length > MAX_CHUNK_SIZE
        ...
        data_chunks.each do |chunk|
          sock.send prepend_chunk_data(chunk, msg_id, i, data_chunks.size), 0, Graylog2::Gelf::GRAYLOG2_HOSTNAME, Graylog2::Gelf::GRAYLOG2_PORT
         i += 1
        end
      else
        # Data fits in datagram without chunking. Send!
        sock.send data, 0, Graylog2::Gelf::GRAYLOG2_HOSTNAME, Graylog2::Gelf::GRAYLOG2_PORT
      end
    end
